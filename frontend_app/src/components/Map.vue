...
let cutout = {
  ...
  sheep: null,
  analytics: null,
  vegetation_change: null,
  animal_gpp: null,
  animal_desertification: null,
...
onMounted(() => {
  ...
  overlayMaps = {
    ...
    vegetation_change: cutout.vegetation_change,
    animal_gpp: cutout.animal_gpp,
    animal_desertification: cutout.animal_desertification,
